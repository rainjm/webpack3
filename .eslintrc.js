module.exports = {
    ...
    "rules": {
        ...
        'comma-dangle': ["error", "only-multiline"], //不强制尾逗号
        'array-bracket-spacing': ["error", "never"], // 不用空格
        'space-in-parens': ["error", "never"], // 不用空格
        'object-curly-spacing': ["error", "never"], // 不用空格
		"no-plusplus": ["off", { "allowForLoopAfterthoughts": true }], //支持++,++浏览器做了优化
